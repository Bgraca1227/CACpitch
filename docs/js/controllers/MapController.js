...
export class MapController {
    ...
    addUserLocationMarker(lat, lng) {
        ...
        // Create a minimalist premium SVG marker
        const svgIcon = `
        ...
        const userLocationIcon = L.divIcon({
            className: 'user-location-marker with-heading medium-accuracy',
            html: `
    ...
    updateSignalStrengthIndicator(accuracy) {
        ...
        this.signalStrengthIndicator.querySelector('.signal-text').textContent = text;
    }
    ...
    updateHeading(heading) {
        ...
        // Use position filter to smooth heading
        const filteredHeading = this.positionFilter.addHeading(heading);
        
        // Store current heading
        this.currentHeading = filteredHeading;
        ...
        if (this.userLocationMarker) {
            ...
            if (markerElement) {
                ...
                if (headingElement) {
                    ...
                    // Update arrow rotation with a smooth transition
    ...
    addOrientationListener() {
        ...
        // Add the listener with error handling
        try {
                ...
                this.watchPositionId = navigator.geolocation.watchPosition(
                    ...
                    (error) => {
                        ...
                        if (this.signalStrengthIndicator) {
                            ...
                            this.signalStrengthIndicator.querySelector('.signal-text').textContent = 'GPS: Error';
                        }
