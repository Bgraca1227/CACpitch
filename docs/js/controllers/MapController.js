            ...
            if (this.userLocationMarker) {
                ...
                if (markerElement) {
                    ...
                    if (headingElement) {
                        ...
                        // The heading value is 0-359 degrees, where 0/360 is North
                        // For the triangle to point in the direction of travel, we need to
                        // apply the rotation correctly (heading is clockwise from north)
