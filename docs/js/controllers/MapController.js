...
export class MapController {
    ...
    updateHeading(heading) {
        ...
        console.log('Updating marker heading to:', this.currentHeading);
        ...
        try {
            if (this.userLocationMarker) {
                ...
                if (markerElement) {
                    console.log('Marker element found:', markerElement.className);
                    
                    // Get the heading element (should only be one)
                    const headingElement = markerElement.querySelector('.location-heading');
                    
                    if (headingElement) {
                        console.log('Heading element found - applying rotation');
                    ...
                    if (!markerElement.classList.contains('with-heading')) {
                        console.log('Adding with-heading class to marker');
    ...
    handleOrientation(e) {
        ...
        if (e.alpha !== null && e.alpha !== undefined) {
            ...
            if (heading >= 0 && heading <= 360) {
                console.log(`${source} heading:`, heading);
                this.processHeading(heading);
            }
        }
    }
