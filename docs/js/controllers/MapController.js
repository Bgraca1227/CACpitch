...
export class MapController {
    ...
    addOrientationListener() {
        ...
        try {
            // Check if the absolute orientation event is available
            if ('ondeviceorientationabsolute' in window) {
                window.addEventListener('deviceorientationabsolute', this.orientationHandler, false);
                this.isOrientationActive = true;
                console.log('Absolute orientation tracking started');
            } else {
