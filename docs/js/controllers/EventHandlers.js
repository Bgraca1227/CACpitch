...
export class EventHandlers {
    ...
    toggleUtilityLayer(utilityType, visible) {
        if (visible) {
            this.mapController.map.addLayer(this.mapController.utilityLayers[utilityType]);
            this.mapController.map.addLayer(this.mapController.structureLayers[utilityType]);
        } else {
            this.mapController.map.removeLayer(this.mapController.utilityLayers[utilityType]);
            this.mapController.map.removeLayer(this.mapController.structureLayers[utilityType]);
        }
    }
    ...
    startMeasurementMode() {
        ...
        this.uiController.showMeasurementPanel();
    ...
    endMeasurementMode() {
        ...
        this.uiController.hideMeasurementPanel();
    ...
    /**
     * Setup measurement tool handlers
     */
    setupMeasurementHandlers() {
        ...
        document.getElementById('finish-measurement-btn')?.addEventListener('click', () => {
            this.endMeasurementMode();
        });
    }
