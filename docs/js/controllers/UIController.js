...
export class UIController {
    ...
    init() {
        // Global event listeners are now registered once in EventHandlers to avoid duplicates.
    ...
    updateProximityAlert(alert) {
        ...
        if (distanceElement) {
            ...
            distanceElement.style.color = this.getDistanceColor(alert.distance);
            ...
            if (alertElement) {
                ...
                if (alert.distance <= 5) {
                    ...
                    // Highlight the alert with a pulse animation
                    alertElement.style.animation = 'pulse 0.5s 3';
                    setTimeout(() => {
    ...
    removeProximityAlert(alertOrId) {
        ...
        if (alertElement) {
            ...
            // Find the alert in the active alerts array and clear its timer if it exists
